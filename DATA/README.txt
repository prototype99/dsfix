...
What is it?
___________
It's an interception DINPUT8.dll that you place in the same folder as the game executable. It intercepts the game's calls to the DirectX9 API & changes them as necessary to enable a higher internal rendering resolution & various other features.
How do I use it?
________________
...
4) Adjust the keybindings in "DSfixKeys.ini" as desired for keybindable actions, including screenshots.
Will it work?
_____________
As of version 1.4, it seems to work well for many people, however your mileage may vary.
"I can not & will not guarantee that it will work for anyone else, or not have any adverse effect on your game/computer. Use at your own risk!"
...
- When using custom HUD settings some things are still not handled correctly (e.g. curse symbol), & the HUD may revert to default spontaneously
...
That depends on your system configuration. Usually, performance scales rather linearly with framebuffer size, & so far this game does not seem different. 
My 660 maintains a locked 30 FPS throughout the majority the game at 2560x1440 with SMAA & SSAO.
Can I donate?
_____________
If you really want to donate I won't say no, I'm not particularly rich :P.
Here is my blog post about the fix with a donation link: http://blog.metaclassofnil.com/?p=92
You can also simply Paypal to peter@metaclassofnil.com
How can I contribute?
_____________________
The source code is now available on github under the terms of the GPL: https://github.com/PeterTh/dsfix
...
If none of these help then check if the problem still occurs when you remove/rename "DINPUT8.dll" or force steam to make a clean install & reinstall the mod
...
- The artists of:
Crow's Claw, Demetori, Silver Forest, Foreground Eclipse, Thousand Leaves, Undead Corporation, Unlucky Morpheus, Dark Phoenix, Aquaelie, TAMUSIC, Riverside, Kissing the Mirror, xi-on, SAVE THE QUEEN, East New Sound & Shinigiwa Satellite
