...
lists
_____
please follow the author's example by creating a section header (where applicable) and subsequently preceding each list item with "- ". when unable to use a section header please write a statement ending in ":".
